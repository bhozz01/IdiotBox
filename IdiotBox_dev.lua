...
local function DrawText(w, h, title)
    ...
    if title == "IdiotBox v7.2.b3" then
        surface.SetTextPos(147, 18 - th / 2)
        surface.SetFont("MainFont2")
        surface.DrawText("Latest build: d17m11-pre01")
    end
end
...
function ib.Changelog() -- Ran out of local variables, again
	print("===============================================================================================\n\n")
	print("IdiotBox v7.2.b3 GENERAL BUGFIXES")
	print("")
	...
	print("\n")
	print("IdiotBox v7.2.b3 ADDITIONS & CHANGES")
	print("")
