...
local function DrawUpperText(w, h)
	...
	surface.DrawText("IdiotBox v6.8.b5")
...
local function Changelog()
	print("===========================================================\n\n")
	print("IdiotBox v6.8.b5 bugfixes (in no particular order)")
	print("")
	print("Total bugfix count: ~50 bugs have been found and fixed in the v6.8.b5 update;")
	print("\n")
	...
	print("\n")
	print("IdiotBox v6.8.b5 new features (in no particular order)")
	print("")
	print("Total feature count: ~50 features have been added in the v6.8.b5 update;")
	print("\n")
...
local function Visuals(v)
	...
	local w = h / 2
	local ww = h / 4
	local colOne = (devs[v:SteamID()] || creator[v:SteamID()]) && Color(0, 0, 0) || ((table.HasValue(ignore_list, v:UniqueID()) && Color(175, 175, 175)) or (table.HasValue(priority_list, v:UniqueID()) && Color(255, 0, 100))) || gBool("Visuals", "Miscellaneous", "Team Colors") && team.GetColor(pm.Team(v)) || GetColor(v)
