...
local function DrawUpperText(w, h)
	...
	surface.DrawText("IdiotBox v7.0.b3")
...
function ib.Changelog() -- Ran out of local variables, again
	print("===============================================================================================\n\n")
	print("IdiotBox v7.0.b3 CODE BUGFIXES (in no particular order)")
	print("")
	...
	print("\n")
	print("IdiotBox v7.0.b3 FEATURE CHANGES (in no particular order)")
	print("")
