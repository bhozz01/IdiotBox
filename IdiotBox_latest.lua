...
local function DrawUpperText(w, h)
	...
	surface.DrawText("IdiotBox v7.0.b5")
	surface.SetTextPos(147, 18 - th / 2)
	surface.SetTextColor(menutextcol.r, menutextcol.g, menutextcol.b, gInt("Adjustments", "Others", "Text Opacity:"))
	surface.SetFont("MainFont2")
	surface.DrawText("Latest build: December 10th 2023")
end
...
function ib.Changelog() -- Ran out of local variables, again
	print("===============================================================================================\n\n")
	print("IdiotBox v7.0.b5 CODE BUGFIXES (in no particular order)")
	print("")
	...
	print("\n")
	print("IdiotBox v7.0.b5 FEATURE CHANGES (in no particular order)")
	print("")
