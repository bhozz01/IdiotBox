...
local function DrawText(w, h, title)
    ...
    if title == "IdiotBox v7.2.b1" then
...
function ib.Changelog() -- Ran out of local variables, again
	print("===============================================================================================\n\n")
	print("IdiotBox v7.2.b1 GENERAL BUGFIXES")
	print("")
	...
	print("\n")
	print("IdiotBox v7.2.b1 ADDITIONS & CHANGES")
	print("")
